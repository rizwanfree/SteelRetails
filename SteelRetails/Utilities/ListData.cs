...
namespace SteelRetails.Utilities
{
    public class ListData
    {
        ...
        public static void LoadDataIntoDataGridView(DataGridView dgv, string storedProcedure, DBParameter[] parameters)
        {
            DBSQLServer db = new DBSQLServer(AppSetting.ConnectionString());
            dgv.DataSource = db.GetDataList(storedProcedure, parameters);
