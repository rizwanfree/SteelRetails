...
namespace DBFramework
{
    public class DBSQLServer
    {
        ...
        public DataRow GetDataRow(string storedProcedure)
        {
            DataTable dt = new DataTable();
            using (SqlConnection conn = new SqlConnection(_connstring))
            {
        ...
        public DataRow GetDataRow(string storedProcedure, DBParameter parameter)
        {
            DataTable dt = new DataTable();
            using (SqlConnection conn = new SqlConnection(_connstring))
            {
        ...
        public DataRow GetDataRow(string storedProcedure, DBParameter[] parameters)
        {
            DataTable dt = new DataTable();
            using (SqlConnection conn = new SqlConnection(_connstring))
            {
